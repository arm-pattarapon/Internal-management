...
export default function Card({ project, deleteProject }: cardProps) {
    ...
    return (
        <div
            ...
            className="bg-white flex flex-col space-y-2 w-full h-fit min-h-[100px] shadow-md rounded px-2 py-1 cursor-grab">
            ...
            <div className="flex justify-center items-center w-full relative">
                <div onMouseEnter={() => setMouseIsOver(true)} className="cursor-pointer rounded-full">
                    <div className="bg-green-200 hover:bg-green-500 text-green-700 text-[12px] px-2 py-1 rounded-full flex items-center justify-center w-5 h-5 select-none opacity-50 hover:opacity-100 transition-all duration-200 ease-in-out">
                        +
                    </div>
                </div>
