...
export default function Card({ project, status, deleteProject, setProjectDialog }: cardProps) {
        ...
        <div
            ...
            <div onClick={toggleProjectDialog} className="flex justify-between items-center">
                ...
                <div className="flex justify-around space-x-5 items-center">
                    ...
                    {mouseIsOver && (
                        <div onClick={() => deleteProject(project._id)} className="cursor-pointer opacity-50 hover:opacity-100 transition-all duration-200 ease-in-out">
            ...
            <div className="flex justify-center items-center w-full relative">
                ...
                <div className="flex absolute left-1/2 translate-x-5">
                    {project.users.slice(0, 3).map((user, index) => (
                        <div key={index} className="w-5 h-5 cursor-pointer overflow-hidden border-white border-1 -ml-2 rounded-full bg-gray-300 flex items-center justify-center text-white text-sm">
            ...
            <Dialog open={isProjectDialogOpen} as="div" className="z-10 focus:outline-none" onClose={toggleProjectDialog}>
                            ...
                            {!editMode ? (
                                <>
                                    <DialogTitle as="h3" className="text-base/7 font-medium text-black">
                                        <div>{project.name}<span className='text-black/50 text-xs align-middle'> {status.title}</span></div>
                                    ...
                                    <div className='grid grid-cols-3 mt-3 justify-center'>
                                        <div className='flex flex-col space-y-1 items-center'>
                                            ...
                                            <div className='text-xs'>{project.projectManager.username}</div>
                                        </div>
                                        <div className='flex flex-col space-y-1 items-center'>
                                            ...
                                            <div className='text-xs'>{project.businessAnalystLead.username}</div>
                                        </div>
                                        <div className='flex flex-col space-y-1 items-center'>
                                            ...
                                            <div className='text-xs'>{project.developerLead.username}</div>
                                        </div>
                                    </div>
                                        ...
                                        <Field>
                                            ...
                                            <Combobox value={selected} onChange={(value) => setSelected(value)} onClose={() => setQuery('')}>
                                                ...
                                                <ComboboxOptions
                                                    ...
                                                    transition
                                                    className={clsx(
                                                        'w-[var(--input-width)] rounded-xl border border-white/5 bg-white backdrop-blur-2xl z-10 p-1 [--anchor-gap:var(--spacing-1)] empty:invisible',
