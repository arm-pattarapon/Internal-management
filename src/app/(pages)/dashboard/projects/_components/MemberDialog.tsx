import { Button, Checkbox, Dialog, DialogPanel, DialogTitle } from '@headlessui/react'
...
function MemberDialog({ isOpen, projectMember, toggleMemberDialog }: props) {
    ...
    return (
        <Dialog open={isOpen} as="div" className="relative z-30 focus:outline-none" onClose={closeDialog}>
            <div className="fixed inset-0 z-30 w-screen overflow-y-auto">
                <div className="flex min-h-full items-center justify-center p-4">
                    ...
                    >
                        ...
                        {users
                            .filter(user => !projectMember || projectMember.every(member => member._id !== user._id))
                            .map(user => (
