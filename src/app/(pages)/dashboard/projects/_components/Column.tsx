...
export default function Column({ projects, deleteProject, deleteColumn, setStatus, setActiveProject, toggleMemberDialog, toggleProjectDialog,toggleStatusDialog , ...column }: Column) {
            ...
            <div className=" bg-[#F0F6FF] w-full h-10 rounded-t-sm px-2 flex items-center justify-between">
                ...
                {mouseIsOver && (
                    <Menu as="div" className="relative">
                        ...
                        <MenuItems aria-labelledby="StatusAction" className="absolute z-10 origin-top-right w-20 right-0 bg-white border-1 shadow-2xl rounded-sm text-center select-none hover:cursor-pointer">
                            <MenuItem as="div" onClick={()=>toggleStatusDialog('Update', column)} className=" hover:bg-blue-500 rounded-t-sm">
                                Edit
                            </MenuItem>
